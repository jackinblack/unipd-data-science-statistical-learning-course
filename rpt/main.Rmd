...
correlation.matrix <- -cov2cor( solve(covariance.matrix) );
independence.matrix <- abs( correlation.matrix ) > threshold;
...
train_index <- sample(1:nrow(seoul.bike.data), 0.7 * nrow(seoul.bike.data)) # 70% for training
