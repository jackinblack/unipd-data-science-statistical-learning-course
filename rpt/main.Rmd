...
TODO: check whether count is 0 on non functioning hours
...
to see if we can notice any trends.
...
Here we notice how bike share demand peaks in summer and it declines in winter implying that the bike 
...
```{r}
hr.clr <- colorRampPalette(c("#FF7F00", "#D95F0E", "#7570B3", "#984EA3", "#6A3D9A"))(24)
